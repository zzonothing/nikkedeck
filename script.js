...
const CHARACTER_DATA = {
    '014': { name: '네온 : 블루 오션', subName: '수네온', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '022': { name: '시그널', subName: '시그널', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '033': { name: '키리', subName: '키리', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '040': { name: 'D', subName: '디', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '041': { name: 'K', subName: '케이', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '043': { name: 'D : 킬러 와이프', subName: '동디', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '062': { name: '미카 : 스노우 버디', subName: '클미카', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '070': { name: '브리드', subName: '브리드', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '071': { name: '솔린', subName: '솔린', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '091': { name: '베스티', subName: '베스티', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '111': { name: '자칼', subName: '자칼', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    ...
    '130': { name: '메어리', subName: '메어리', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '131': { name: '페퍼', subName: '페퍼', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '132': { name: '메어리 : 베이 갓데스', subName: '수어리', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '140': { name: '슈가', subName: '슈가', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '141': { name: '밀크', subName: '밀크', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '142': { name: '프림', subName: '프림', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '150': { name: '율리아', subName: '율리아', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '160': { name: '유니', subName: '유니', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '181': { name: '메이든', subName: '메이든', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '190': { name: '루드밀라', subName: '루드밀라', attribute: '', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    ...
    '200': { name: '루피', subName: '루피', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '201': { name: '얀', subName: '얀', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '202': { name: '도라', subName: '도라', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '203': { name: '루피 : 윈터 쇼퍼', subName: '클루피', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    ...
    '224': { name: '스노우 화이트 : 이노센트 데이즈', subName: '스화', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '225': { name: '홍련 : 흑영', subName: '흑영', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '226': { name: '라푼젤 : 퓨어 그레이스', subName: '라푼젤', attribute: '철갑', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '230': { name: '하란', subName: '하란', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '240': { name: '루마니', subName: '루마니', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '241': { name: '에피넬', subName: '에피넬', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '242': { name: '폴크방', subName: '폴크방', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '260': { name: '모더니아', subName: '모더니아', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '261': { name: '니힐리스타', subName: '니힐리스타', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '280': { name: '로산나', subName: '로산나', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '281': { name: '목단', subName: '목단', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '282': { name: '사쿠라', subName: '사쿠라', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    ...
    '350': { name: '마스트', subName: '마스트', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '361': { name: '킬로', subName: '킬로', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '380': { name: '네로', subName: '네로', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '390': { name: '츠바이', subName: '츠바이', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '391': { name: '아인', subName: '아인', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    '392': { name: '라이', subName: '라이', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    '400': { name: '길티', subName: '길티', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '401': { name: '신', subName: '신', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '402': { name: '퀀시', subName: '퀀시', attribute: '전격', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    ...
    '501': { name: '트로니', subName: '트로니', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
    ...
    '532': { name: '소라', subName: '소라', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '1' },
    ...
    '590': { name: '모리', subName: '모리', attribute: '풍압', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '800': { name: '마키마', subName: '마키마', attribute: '수냉', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '2' },
    '801': { name: '파워', subName: '파워', attribute: '작열', rarity: 'SSR', manufacturer: '', class: '', weapon: '', burst: '3' },
